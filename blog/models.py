...
class Post(models.Model):
    ...
    image = models.ImageField(default='kalai_logo_1.png', blank=True)
    image_1 = models.ImageField(default='', blank=True)
    image_2 = models.ImageField(default='', blank=True)
    image_3 = models.ImageField(default='', blank=True)
